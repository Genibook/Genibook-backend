...
func functionForGpashandlerV2(c *gin.Context, w http.ResponseWriter, r *http.Request, email string, password string, highSchool string, userSelector int, student_grade int) (gpas map[string]float64, err error) {
